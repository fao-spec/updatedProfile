...
export const Contact = () => {
 ...
 <section id="contact" ref={sectionRef} className="py-20">
  ...
  {/* Parent container — full 90% width of viewport, no extra padding, responsive layout */}
  <div
    className={`transition-all duration-1000 transform 
      ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}
      w-[90vw] max-w-6xl mx-auto flex flex-col lg:flex-row lg:items-start lg:justify-between lg:gap-16
    `}
  >
    {/* LEFT SIDE — Heading + Text + Social Icons */}
    <div className="flex flex-col items-start text-left w-full lg:w-1/2">
      ...
      <p className="text-base sm:text-lg text-gray-400 mb-10 max-w-full">
      ...
      {/* Social Icons */}
      <div className="flex flex-wrap justify-start items-center gap-3 sm:gap-4 md:gap-6 select-none lg:mt-10">
    ...
    <div className="mt-12 lg:mt-0 w-full lg:w-1/2 space-y-6">
      <input
        type="text"
        name="name"
